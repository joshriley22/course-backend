...
import { fetchCodes, fetchCourseEdges, fetchMajors } from './api/courses';
...
function App() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', position: 'relative', width: '100vw', height: '100vh', alignItems: 'center' }}>
      <Header codes={codes} currentIndex={currentIndex} onPrev={handlePrev} onNext={handleNext} height={'60px'} background={'#1e293b'} />
        <Header codes={codes} currentIndex={currentIndex} onPrev={handlePrev} onNext={handleNext} height={'45px'} background={'#ffffff'} fontColor={'2b2727'}/>
